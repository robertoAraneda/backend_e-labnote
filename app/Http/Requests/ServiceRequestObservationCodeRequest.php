...
class ServiceRequestObservationCodeRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'specimen_code_id.required' => $this->getRequiredMessage(),
            ...
            'location_id.required' => $this->getRequiredMessage(),
            ...
            'specimen_code_id.integer' => $this->getIntegerMessage(),
            ...
            'location_id.integer' => $this->getIntegerMessage(),
