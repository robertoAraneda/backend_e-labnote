...
use Database\Seeders\ServiceRequestStatusPermissionsSeeder;
...
class ServiceRequestStatusTest extends TestCase
{
    ...
    const BASE_URI = '/api/v1/service-request-statuses';
    ...
    public function setUp(): void
    {
        ...
        $modelClass = new ServiceRequestStatus();

        $this->user = $user;
        $this->role = $role;
        $this->model = ServiceRequestStatus::factory()->create();
        $this->perPage = $modelClass->getPerPage();
        $this->table = 'service_request_statuses';
    ...
    public function test_se_puede_obtener_una_lista_del_recurso(): void
    {
        ...
        ServiceRequestStatus::factory()->count(20)->create();

        $uri = sprintf('%s', self::BASE_URI);
        $countModels = ServiceRequestStatus::count();
    ...
    public function test_se_genera_error_http_forbidden_al_crear_un_recurso_sin_privilegios(): void
    {
        ...
        $this->role->revokePermissionTo('serviceRequestStatus.create');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestStatus.update');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestStatus.delete');
    ...
    public function test_se_puede_obtener_una_lista_cuando_se_modifica_el_limite_del_paginador(): void
    {
        ...
        $list = ServiceRequestStatus::count();
