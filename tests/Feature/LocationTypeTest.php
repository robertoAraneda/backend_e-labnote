...
use App\Models\Role;
use App\Models\User;
use Database\Seeders\LocationTypePermissionsSeeder;
...
class LocationTypeTest extends TestCase
{
    ...
    const BASE_URI = '/api/v1/location-types';
    ...
    public function setUp(): void
    {
        ...
        $modelClass = new LocationType();

        $this->user = $user;
        $this->role = $role;
        $this->model = LocationType::factory()->create();
    ...
    public function test_se_puede_obtener_una_lista_del_recurso(): void
    {
        ...
        LocationType::factory()->count(20)->create();

        $uri = sprintf('%s', self::BASE_URI);
        $countModels = LocationType::count();
    ...
    public function test_se_genera_error_http_forbidden_al_crear_un_recurso_sin_privilegios(): void
    {
        ...
        $this->role->revokePermissionTo('locationType.create');
    ...
    {
        $this->role->revokePermissionTo('locationType.update');
    ...
    {
        $this->role->revokePermissionTo('locationType.delete');
