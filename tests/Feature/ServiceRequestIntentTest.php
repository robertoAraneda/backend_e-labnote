...
use Database\Seeders\ServiceRequestIntentPermissionsSeeder;
...
class ServiceRequestIntentTest extends TestCase
{
    ...
    const BASE_URI = '/api/v1/service-request-intents';
    ...
    public function setUp(): void
    {
        ...
        $modelClass = new ServiceRequestIntent();

        $this->user = $user;
        $this->role = $role;
        $this->model = ServiceRequestIntent::factory()->create();
        $this->perPage = $modelClass->getPerPage();
        $this->table = 'service_request_intents';
    ...
    public function test_se_puede_obtener_una_lista_del_recurso(): void
    {
        ...
        ServiceRequestIntent::factory()->count(20)->create();

        $uri = sprintf('%s', self::BASE_URI);
        $countModels = ServiceRequestIntent::count();
    ...
    public function test_se_genera_error_http_forbidden_al_crear_un_recurso_sin_privilegios(): void
    {
        ...
        $this->role->revokePermissionTo('serviceRequestIntent.create');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestIntent.update');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestIntent.delete');
    ...
    public function test_se_puede_obtener_una_lista_cuando_se_modifica_el_limite_del_paginador(): void
    {
        ...
        $list = ServiceRequestIntent::count();
