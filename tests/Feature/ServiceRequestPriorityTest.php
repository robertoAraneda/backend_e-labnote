...
use Database\Seeders\ServiceRequestPriorityPermissionsSeeder;
...
class ServiceRequestPriorityTest extends TestCase
{
    ...
    const BASE_URI = '/api/v1/service-request-priorities';
    ...
    public function setUp(): void
    {
        ...
        $modelClass = new ServiceRequestPriority();

        $this->user = $user;
        $this->role = $role;
        $this->model = ServiceRequestPriority::factory()->create();
        $this->perPage = $modelClass->getPerPage();
        $this->table = 'service_request_priorities';
    ...
    public function test_se_puede_obtener_una_lista_del_recurso(): void
    {
        ...
        ServiceRequestPriority::factory()->count(20)->create();

        $uri = sprintf('%s', self::BASE_URI);
        $countModels = ServiceRequestPriority::count();
    ...
    public function test_se_genera_error_http_forbidden_al_crear_un_recurso_sin_privilegios(): void
    {
        ...
        $this->role->revokePermissionTo('serviceRequestPriority.create');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestPriority.update');
    ...
    {
        $this->role->revokePermissionTo('serviceRequestPriority.delete');
    ...
    public function test_se_puede_obtener_una_lista_cuando_se_modifica_el_limite_del_paginador(): void
    {
        ...
        $list = ServiceRequestPriority::count();
